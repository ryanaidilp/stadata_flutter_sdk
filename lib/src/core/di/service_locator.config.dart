...
import 'package:stadata_flutter_sdk/src/features/domains/domain/usecases/get_domains.dart'
    as _i21;
import 'package:stadata_flutter_sdk/src/features/features.dart' as _i51;
...
import 'package:stadata_flutter_sdk/src/view/view.dart' as _i45;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i17.GetDetailNews>(() => _i17.GetDetailNews());
  gh.lazySingleton<_i18.GetDetailPressRelease>(
      () => _i18.GetDetailPressRelease());
  gh.lazySingleton<_i19.GetDetailPublication>(
      () => _i19.GetDetailPublication());
  gh.lazySingleton<_i20.GetDetailStaticTable>(
  ...
  gh.lazySingleton<_i23.InfographicRemoteDataSource>(
      () => _i23.InfographicRemoteDataSourceImpl());
  gh.lazySingleton<_i24.InfographicRepository>(
      () => _i25.InfographicRepositoryImpl());
  gh.lazySingleton<_i26.LocalStorage>(
    () => _i27.SecureStorageImpl(),
    instanceName: 'secure',
  );
  gh.lazySingleton<_i28.Log>(() => _i28.Log());
  gh.factory<_i29.Logger>(() => registerModule.logger);
  gh.lazySingleton<_i30.NewsCategoryRemoteDataSource>(
      () => _i30.NewsCategoryRemoteDataSourceImpl());
  gh.lazySingleton<_i31.NewsCategoryRepository>(
      () => _i32.NewsCategoryRepositoryImpl());
  gh.lazySingleton<_i33.NewsRemoteDataSource>(
      () => _i33.NewsRemoteDataSourceImpl());
  gh.lazySingleton<_i34.NewsRepository>(() => _i35.NewsRepositoryImpl());
  gh.lazySingleton<_i36.PressReleaseRemoteDataSource>(
      () => _i36.PressReleaseRemoteDataSourceImpl());
  gh.lazySingleton<_i37.PressReleaseRepository>(
      () => _i38.PressReleaseRepositoryImpl());
  gh.lazySingleton<_i39.PublicationRemoteDataSource>(
      () => _i39.PublicationRemoteDataSourceImpl());
  gh.lazySingleton<_i40.PublicationRepository>(
      () => _i41.PublicationRepositoryImpl());
  gh.lazySingleton<_i42.StadataHttpModule>(() => _i42.StadataHttpModule());
  gh.lazySingleton<_i43.StadataList>(() => _i43.StadataListImpl());
  gh.lazySingleton<_i44.StadataListHttpModule>(
      () => _i44.StadataListHttpModule());
  gh.lazySingleton<_i45.StadataView>(() => _i45.StadataViewImpl());
  gh.lazySingleton<_i46.StadataViewHttpModule>(
      () => _i46.StadataViewHttpModule());
  gh.lazySingleton<_i47.StaticTableRemoteDataSource>(
      () => _i47.StaticTableRemoteDataSourceImpl());
  gh.lazySingleton<_i48.StaticTableRepository>(
      () => _i49.StaticTableRepositoryImpl());
  gh.lazySingleton<_i50.StrategicIndicatorRemoteDataSource>(
      () => _i50.StrategicIndicatorRemoteDataSourceImpl());
  gh.lazySingleton<_i51.StrategicIndicatorRepository>(
      () => _i52.StrategicIndicatorRepositoryImpl());
  gh.lazySingleton<_i53.SubjectCategoryRemoteDataSource>(
      () => _i53.SubjectCategoryRemoteDataSourceImpl());
  gh.lazySingleton<_i54.SubjectCategoryRepository>(
      () => _i55.SubjectCategoryRepositoryImpl());
