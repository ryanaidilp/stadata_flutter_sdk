...
import 'package:stadata_flutter_sdk/src/core/di/register_module.dart' as _i38;
...
import 'package:stadata_flutter_sdk/src/features/news/domain/usecases/get_detail_news.dart'
    as _i12;
import 'package:stadata_flutter_sdk/src/features/news_category/domain/usecases/get_all_news_category.dart'
    as _i9;
...
import 'package:stadata_flutter_sdk/src/features/static_tables/domain/usecases/get_detail_static_table.dart'
    as _i14;
import 'package:stadata_flutter_sdk/src/list/list.dart' as _i31;
import 'package:stadata_flutter_sdk/src/view/view.dart' as _i33;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i9.GetAllNewsCategory>(() => _i9.GetAllNewsCategory());
  ...
  gh.lazySingleton<_i24.NewsRemoteDataSource>(
      () => _i24.NewsRemoteDataSourceImpl());
  gh.lazySingleton<_i25.NewsRepository>(() => _i26.NewsRepositoryImpl());
  gh.lazySingleton<_i27.PublicationRemoteDataSource>(
      () => _i27.PublicationRemoteDataSourceImpl());
  gh.lazySingleton<_i28.PublicationRepository>(
      () => _i29.PublicationRepositoryImpl());
  gh.lazySingleton<_i30.StadataHttpModule>(() => _i30.StadataHttpModule());
  gh.lazySingleton<_i31.StadataList>(() => _i31.StadataListImpl());
  gh.lazySingleton<_i32.StadataListHttpModule>(
      () => _i32.StadataListHttpModule());
  gh.lazySingleton<_i33.StadataView>(() => _i33.StadataViewImpl());
  gh.lazySingleton<_i34.StadataViewHttpModule>(
      () => _i34.StadataViewHttpModule());
  gh.lazySingleton<_i35.StaticTableRemoteDataSource>(
      () => _i35.StaticTableRemoteDataSourceImpl());
  gh.lazySingleton<_i36.StaticTableRepository>(
      () => _i37.StaticTableRepositoryImpl());
  return getIt;
}
