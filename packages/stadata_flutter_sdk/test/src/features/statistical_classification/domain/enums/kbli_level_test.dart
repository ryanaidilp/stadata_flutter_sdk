      ...
      group(
        ...
        () {
          test(
            ...
            () => expect(
              KBLILevel.category.validateCode('A'),
              isTrue,
            ),
          );
          test(
            ...
            () => expect(
              KBLILevel.primaryGroup.validateCode('A1'),
              isTrue,
            ),
          );
          test(
            ...
            () => expect(
              KBLILevel.group.validateCode('A13'),
              isTrue,
            ),
          );
          test(
            ...
            () => expect(
              KBLILevel.subGroup.validateCode('A133'),
              isTrue,
            ),
          );
          test(
            ...
            () => expect(
              KBLILevel.cluster.validateCode('A1335'),
              isTrue,
            ),
          );
        },
