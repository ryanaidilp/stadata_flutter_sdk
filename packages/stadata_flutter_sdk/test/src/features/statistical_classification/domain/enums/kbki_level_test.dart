      ...
      group(
        ...
        () {
          test(
            ...
            () => expect(
              KBKILevel.section.validateCode('1'),
              isTrue,
            ),
          );
          test(
            ...
            () => expect(
              KBKILevel.division.validateCode('13'),
              isTrue,
            ),
          );
          test(
            ...
            () => expect(
              KBKILevel.group.validateCode('135'),
              isTrue,
            ),
          );
          test(
            ...
            () => expect(
              KBKILevel.classes.validateCode('1357'),
              isTrue,
            ),
          );
          test(
            ...
            () => expect(
              KBKILevel.subClass.validateCode('13579'),
              isTrue,
            ),
          );
          test(
            ...
            () => expect(
              KBKILevel.commodityGroup.validateCode('1357911'),
              isTrue,
            ),
          );
          test(
            ...
            () => expect(
              KBKILevel.commodity.validateCode('1357911013'),
              isTrue,
            ),
          );
        },
