...
void main() {
  ...
  group('GetAllVerticalVariables', () {
    test('should return list of vertical variables if call success', () async {
      // arrange
      when(
      ...
      expect(
        result,
        equals(
          Result.success<Failure, ApiResponse<List<VerticalVariable>>>(data),
        ),
      );
