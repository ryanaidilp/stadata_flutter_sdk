...
void main() {
  ...
  setUpAll(() {
    ...
    subjects = ApiResponseModel<List<SubjectModel>?>.fromJson(response, (json) {
  ...
  group('SubjectRemoteDataSource', () {
    group('get()', () {
      ...
      test('should throw SubjectNotAvailableException when '
        ...
        await expectLater(
          result,
          throwsA(const SubjectNotAvailableException()),
        );
        verify(
          () => mockListClient.get<JSON>(
            ApiEndpoint.subject,
