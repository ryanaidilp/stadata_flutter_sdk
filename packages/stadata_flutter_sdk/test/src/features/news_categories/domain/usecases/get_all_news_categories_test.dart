...
void main() {
  ...
  setUpAll(() {
    ...
    final response = ApiResponseModel<List<NewsCategoryModel>?>.fromJson(json, (
      json,
    ) {
  ...
  group('GetAllNewsCategory', () {
    test('should return list of news categories if call success', () async {
      // arrange
      when(
      ...
      expect(
        result,
        equals(Result.success<Failure, ApiResponse<List<NewsCategory>>>(data)),
      );
