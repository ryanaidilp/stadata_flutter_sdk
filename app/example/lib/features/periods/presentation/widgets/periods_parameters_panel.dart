...
class PeriodsParametersPanel extends StatefulWidget {
  const PeriodsParametersPanel({super.key});

  @override
  State<PeriodsParametersPanel> createState() => _PeriodsParametersPanelState();
}

class _PeriodsParametersPanelState extends State<PeriodsParametersPanel> {
