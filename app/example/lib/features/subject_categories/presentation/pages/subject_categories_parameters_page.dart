...
@RoutePage()
class SubjectCategoriesParametersPage extends StatefulWidget {
  const SubjectCategoriesParametersPage({super.key});

  @override
  State<SubjectCategoriesParametersPage> createState() =>
      _SubjectCategoriesParametersPageState();
}

class _SubjectCategoriesParametersPageState
    extends State<SubjectCategoriesParametersPage> {
          ...
          return Scaffold(
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  SubjectCategoriesParametersPanel(
