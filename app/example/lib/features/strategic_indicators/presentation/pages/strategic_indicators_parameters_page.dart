...
@RoutePage()
class StrategicIndicatorsParametersPage extends StatefulWidget {
  const StrategicIndicatorsParametersPage({super.key});

  @override
  State<StrategicIndicatorsParametersPage> createState() =>
      _StrategicIndicatorsParametersPageState();
}
...
class _StrategicIndicatorsParametersPageState
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => getIt<StrategicIndicatorsCubit>()..initialize(),
      child: BlocBuilder<StrategicIndicatorsCubit, BaseState>(
        builder: (context, state) {
          final cubit = context.read<StrategicIndicatorsCubit>();

          return Scaffold(
            appBar: AppBar(title: Text(t.strategicIndicators.title)),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: FilledButton.icon(
                      ...
                      label: Text(t.strategicIndicators.parameters.loadButton),
