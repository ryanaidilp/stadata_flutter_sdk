...
/// A widget that displays request details for educational purposes
class InfographicsRequestDetailsPanel extends StatelessWidget {
  const InfographicsRequestDetailsPanel({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                if (requestDetails == null)
                  ...
                  DetailRow(
                    label: t.infographics.requestDetails.method,
                  ...
                  DetailRow(
                    ...
                    onCopy:
                        () => _copyToClipboard(
                          context,
                          requestDetails.url,
                          t.infographics.requestDetails.urlCopied,
                        ),
                  ),
                  const Gap(AppSizes.spaceSm),
                  DetailRow(
                  ...
                  const Gap(AppSizes.spaceSm),
                  DetailRow(
                    label: t.infographics.requestDetails.responseTime,
                    value:
