...
class DerivedVariablesParametersPanel extends StatefulWidget {
  const DerivedVariablesParametersPanel({super.key});

  @override
  State<DerivedVariablesParametersPanel> createState() =>
      _DerivedVariablesParametersPanelState();
}

class _DerivedVariablesParametersPanelState
    extends State<DerivedVariablesParametersPanel> {
