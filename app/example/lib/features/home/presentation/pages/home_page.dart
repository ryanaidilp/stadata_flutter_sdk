              ...
              children: [
                ...
                _HomeFeatureSection(
                  ...
                  features: [
                    ...
                    _FeatureItem(
                      title: t.listApi.sections.periods.title,
                      description: t.listApi.sections.periods.description,
                      icon: Icons.calendar_today,
                      color: Colors.lightBlue,
                      onTap: () => context.router.push(const PeriodsRoute()),
                    ),
                    _FeatureItem(
                      title: t.listApi.sections.derivedPeriods.title,
                      description:
                          t.listApi.sections.derivedPeriods.description,
                      icon: Icons.date_range,
                      color: Colors.blue,
                      onTap:
                          () =>
                              context.router.push(const DerivedPeriodsRoute()),
                    ),
                    _FeatureItem(
                      title: t.listApi.sections.derivedVariables.title,
                      description:
                          t.listApi.sections.derivedVariables.description,
                      icon: Icons.functions,
                      color: Colors.deepPurple,
                      onTap:
                          () => context.router.push(
                            const DerivedVariablesRoute(),
                          ),
                    ),
                    _FeatureItem(
                      ...
                      onTap:
                          () => context.router.push(
                            const DynamicTablesRoute(),
                          ),
                    ),
                    _FeatureItem(
                      title: t.listApi.sections.glossary.title,
                      description: t.listApi.sections.glossary.description,
                      icon: Icons.menu_book,
                      color: Colors.brown,
                      onTap: () => context.router.push(const GlossaryRoute()),
                    ),
                    _FeatureItem(
                      title: t.listApi.sections.sdgIndicators.title,
                      description: t.listApi.sections.sdgIndicators.description,
                      icon: Icons.public,
                      color: Colors.green,
                      onTap:
                          () => context.router.push(
                            const SdgIndicatorsRoute(),
                          ),
                    ),
