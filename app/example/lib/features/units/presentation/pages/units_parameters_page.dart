...
import 'package:stadata_example/features/units/presentation/widgets/units_parameters_panel.dart';
import 'package:stadata_example/shared/cubit/base_cubit.dart';

@RoutePage()
class UnitsParametersPage extends StatelessWidget {
  const UnitsParametersPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => getIt<UnitsCubit>(),
