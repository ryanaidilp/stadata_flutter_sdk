...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'app.title': return 'STADATA Example';
			case 'app.description': return 'Showcase of STADATA Flutter SDK capabilities';
			case 'navigation.home': return 'Home';
			case 'navigation.listApi': return 'List API';
			case 'navigation.viewApi': return 'View API';
			case 'navigation.dynamicTables': return 'Dynamic Tables';
			case 'navigation.periods': return 'Periods';
			case 'navigation.pageNotFound': return 'Page Not Found';
			case 'navigation.pageNotFoundMessage': return 'The page you are looking for does not exist.';
			case 'common.loading': return 'Loading...';
			case 'common.error': return 'Error';
			case 'common.retry': return 'Retry';
			case 'common.noData': return 'No data available';
			...
			case 'common.previous': return 'Previous';
			case 'common.page': return 'Page';
			case 'common.total': return 'Total';
			case 'common.items': return 'items';
			case 'common.of': return 'of';
			case 'common.language': return 'Language';
			case 'common.unknownState': return 'Unknown state';
			case 'errors.generic': return 'Something went wrong. Please try again.';
			case 'errors.network': return 'Network error. Please check your connection.';
			case 'errors.notFound': return 'Data not found.';
			case 'errors.timeout': return 'Request timeout. Please try again.';
			case 'errors.unauthorized': return 'Unauthorized access.';
			case 'errors.serverError': return 'Server error. Please try again later.';
			case 'home.title': return 'Welcome to STADATA';
			case 'home.subtitle': return 'Explore Indonesian Statistical Data';
			case 'home.description': return 'Access comprehensive statistical data from Badan Pusat Statistik (BPS) Indonesia through this showcase application.';
			case 'home.features.title': return 'Features';
			case 'home.aboutDemo.title': return 'About This Demo';
			case 'home.aboutDemo.description': return 'This simplified example demonstrates the domains functionality of the STADATA Flutter SDK. Click on the domains card above to explore statistical domains from BPS Indonesia.';
			case 'home.sections.listApi.title': return 'List API';
			case 'home.sections.listApi.description': return 'Browse collections of domains, publications, news, and more';
			case 'home.sections.viewApi.title': return 'View API';
			case 'home.sections.viewApi.description': return 'Get detailed information about specific publications, news, and press releases';
			case 'home.sections.dynamicTables.title': return 'Dynamic Tables';
			case 'home.sections.dynamicTables.description': return 'Explore dynamic statistical tables with customizable parameters';
			case 'home.sections.periods.title': return 'Periods';
			case 'home.sections.periods.description': return 'Browse available time periods for statistical data';
			case 'listApi.title': return 'List API';
			case 'listApi.subtitle': return 'Explore statistical data collections from BPS';
			case 'listApi.sections.domains.title': return 'Domains';
			case 'listApi.sections.domains.description': return 'Statistical domains and regions';
			case 'listApi.sections.publications.title': return 'Publications';
			case 'listApi.sections.publications.description': return 'Statistical publications and reports';
			case 'listApi.sections.news.title': return 'News';
			case 'listApi.sections.news.description': return 'Latest statistical news and updates';
			case 'listApi.sections.pressReleases.title': return 'Press Releases';
			case 'listApi.sections.pressReleases.description': return 'Official press releases from BPS';
			case 'listApi.sections.infographics.title': return 'Infographics';
			case 'listApi.sections.infographics.description': return 'Visual statistical information';
			case 'listApi.sections.newsCategories.title': return 'News Categories';
			case 'listApi.sections.newsCategories.description': return 'Browse news category classifications from BPS';
			case 'listApi.sections.dynamicTables.title': return 'Dynamic Tables';
			case 'listApi.sections.dynamicTables.description': return 'Explore multi-dimensional statistical data with periods integration';
			case 'listApi.sections.staticTables.title': return 'Static Tables';
			case 'listApi.sections.staticTables.description': return 'Pre-defined statistical tables';
			case 'listApi.sections.strategicIndicators.title': return 'Strategic Indicators';
			case 'listApi.sections.strategicIndicators.description': return 'Key performance indicators';
			case 'listApi.sections.subjects.title': return 'Subjects';
			case 'listApi.sections.subjects.description': return 'Statistical subject categories';
			case 'listApi.sections.variables.title': return 'Variables';
			case 'listApi.sections.variables.description': return 'Statistical variables and measures';
			case 'listApi.sections.units.title': return 'Units';
			case 'listApi.sections.units.description': return 'Units of measurement';
			case 'viewApi.title': return 'View API';
			case 'viewApi.subtitle': return 'Detailed information views';
			case 'viewApi.sections.publication.title': return 'Publication Details';
			case 'viewApi.sections.publication.description': return 'Detailed publication information';
			case 'viewApi.sections.news.title': return 'News Details';
			case 'viewApi.sections.news.description': return 'Detailed news article';
			case 'viewApi.sections.pressRelease.title': return 'Press Release Details';
			case 'viewApi.sections.pressRelease.description': return 'Detailed press release';
			case 'viewApi.sections.staticTable.title': return 'Static Table Details';
			case 'viewApi.sections.staticTable.description': return 'Detailed table information';
			case 'domains.title': return 'Domains';
			case 'domains.types.province': return 'Province';
			case 'domains.types.regency': return 'Regency';
			case 'domains.types.regencyByProvince': return 'Regency by Province';
			case 'domains.types.all': return 'All Domains';
			case 'domains.fields.id': return 'ID';
			case 'domains.fields.name': return 'Name';
			case 'domains.fields.url': return 'URL';
			case 'domains.parameters.title': return 'API Parameters';
			case 'domains.parameters.domainType': return 'Domain Type';
			case 'domains.parameters.provinceCode': return 'Province Code';
			case 'domains.parameters.provinceCodeHint': return 'e.g., 32 for West Java';
			case 'domains.parameters.provinceCodeRequired': return 'Province code is required for Regency by Province type';
			case 'domains.parameters.language': return 'Language';
			case 'domains.parameters.languageNote': return 'Educational - not applied to domains endpoint';
			case 'domains.parameters.loadButton': return 'Load Domains';
			case 'domains.parameters.loading': return 'Loading...';
			case 'domains.parameters.searchDomains': return 'Search Domains';
			case 'domains.requestDetails.title': return 'Request Details';
			case 'domains.requestDetails.method': return 'Method';
			case 'domains.requestDetails.url': return 'URL';
			case 'domains.requestDetails.parameters': return 'Parameters';
			case 'domains.requestDetails.responseTime': return 'Response Time';
			case 'domains.requestDetails.copyUrl': return 'Copy URL';
			case 'domains.requestDetails.urlCopied': return 'URL copied to clipboard';
			case 'domains.requestDetails.noRequest': return 'No request made yet';
			case 'domains.requestDetails.showDetails': return 'Show Request Details';
			case 'domains.requestDetails.hideDetails': return 'Hide Request Details';
			case 'domains.results.title': return 'Domain Results';
			case 'domains.results.found': return 'Found {count} domain(s)';
			case 'domains.results.empty': return 'No domains found for the selected criteria';
			case 'domains.results.initial': return 'Select parameters and click "Load Domains" to start';
			case 'domains.results.searchParameters': return 'Search Parameters';
			case 'domains.education.title': return 'How to Use';
			case 'domains.education.description': return 'Learn how to search and explore domain data from BPS.';
			case 'domains.education.parameters': return 'Parameters';
			case 'domains.education.parametersDescription': return 'Configure domain type and region settings';
			case 'domains.education.results': return 'Results';
			case 'domains.education.resultsDescription': return 'View domains matching your criteria';
			case 'domains.education.detail': return 'Detail';
			case 'domains.education.detailDescription': return 'See domain information and access links';
			case 'infographics.title': return 'Infographics';
			case 'infographics.fields.id': return 'ID';
			case 'infographics.fields.title': return 'Title';
			case 'infographics.fields.image': return 'Image';
			case 'infographics.fields.description': return 'Description';
			case 'infographics.fields.category': return 'Category';
			case 'infographics.fields.downloadUrl': return 'Download URL';
			case 'infographics.parameters.title': return 'API Parameters';
			case 'infographics.parameters.domain': return 'Domain';
			case 'infographics.parameters.domainHint': return 'e.g., 7200 for national level';
			case 'infographics.parameters.keyword': return 'Keyword (Optional)';
			case 'infographics.parameters.keywordHint': return 'Filter by keyword';
			case 'infographics.parameters.page': return 'Page';
			case 'infographics.parameters.language': return 'Language';
			case 'infographics.parameters.languageNote': return 'Applied to infographics content language';
			case 'infographics.parameters.loadButton': return 'Load Infographics';
			case 'infographics.parameters.loading': return 'Loading...';
			case 'infographics.parameters.searchInfographics': return 'Search Infographics';
			case 'infographics.requestDetails.title': return 'Request Details';
			case 'infographics.requestDetails.method': return 'Method';
			case 'infographics.requestDetails.url': return 'URL';
			case 'infographics.requestDetails.parameters': return 'Parameters';
			case 'infographics.requestDetails.responseTime': return 'Response Time';
			case 'infographics.requestDetails.copyUrl': return 'Copy URL';
			case 'infographics.requestDetails.urlCopied': return 'URL copied to clipboard';
			case 'infographics.requestDetails.noRequest': return 'No request made yet';
			case 'infographics.requestDetails.showDetails': return 'Show Request Details';
			case 'infographics.requestDetails.hideDetails': return 'Hide Request Details';
			case 'infographics.results.title': return 'Results';
			case 'infographics.results.found': return 'Found {count} infographic(s)';
			case 'infographics.results.empty': return 'No infographics found for the selected criteria';
			case 'infographics.results.initial': return 'Configure parameters and click "Load Infographics" to start';
			case 'infographics.results.searchParameters': return 'Search Parameters';
			case 'infographics.education.title': return 'Tips';
			case 'infographics.education.description': return 'Learn how to use the infographics feature effectively.';
			case 'infographics.education.parameters': return 'Parameters';
			case 'infographics.education.parametersDescription': return 'Configure your search criteria here';
			case 'infographics.education.results': return 'Results';
			case 'infographics.education.resultsDescription': return 'View infographics matching your criteria';
			case 'infographics.education.detail': return 'Detail';
			case 'infographics.education.detailDescription': return 'See full content and download options';
			case 'publications.title': return 'Publications';
			case 'publications.comingSoon': return 'Publications Page - Coming Soon';
			case 'publications.detail.title': return 'Publication Detail';
			case 'publications.fields.id': return 'ID';
			case 'publications.fields.title': return 'Title';
			case 'publications.fields.issn': return 'ISSN';
			case 'publications.fields.cover': return 'Cover';
			case 'publications.fields.pdfUrl': return 'PDF URL';
			case 'publications.fields.size': return 'Size';
			case 'publications.fields.abstract': return 'Abstract';
			case 'publications.fields.catalogueNumber': return 'Catalogue Number';
			case 'publications.fields.publicationNumber': return 'Publication Number';
			case 'publications.fields.releaseDate': return 'Release Date';
			case 'publications.fields.updatedAt': return 'Updated At';
			case 'news.title': return 'News';
			case 'news.categories': return 'Categories';
			case 'news.fields.id': return 'ID';
			case 'news.fields.title': return 'Title';
			case 'news.fields.content': return 'Content';
			case 'news.fields.picture': return 'Picture';
			case 'news.fields.releaseDate': return 'Release Date';
			case 'news.fields.category': return 'Category';
			case 'news.fields.categoryID': return 'Category ID';
			case 'news.parameters.title': return 'API Parameters';
			case 'news.parameters.domain': return 'Domain';
			case 'news.parameters.domainHint': return 'e.g., 7200 for Central Sulawesi';
			case 'news.parameters.keyword': return 'Keyword (Optional)';
			case 'news.parameters.keywordHint': return 'Filter by keyword';
			case 'news.parameters.category': return 'Category ID (Optional)';
			case 'news.parameters.categoryHint': return 'Filter by news category ID';
			case 'news.parameters.month': return 'Month (Optional)';
			case 'news.parameters.monthHint': return 'Select month';
			case 'news.parameters.year': return 'Year (Optional)';
			case 'news.parameters.yearHint': return 'Select year';
			case 'news.parameters.page': return 'Page';
			case 'news.parameters.language': return 'Language';
			case 'news.parameters.languageNote': return 'Applied to news content language';
			case 'news.parameters.loadButton': return 'Load News';
			case 'news.parameters.searchNews': return 'Search News';
			case 'news.parameters.clearButton': return 'Clear Filters';
			case 'news.parameters.loading': return 'Loading...';
			case 'news.requestDetails.title': return 'Request Details';
			case 'news.requestDetails.method': return 'Method';
			case 'news.requestDetails.url': return 'URL';
			case 'news.requestDetails.parameters': return 'Parameters';
			case 'news.requestDetails.responseTime': return 'Response Time';
			case 'news.requestDetails.copyUrl': return 'Copy URL';
			case 'news.requestDetails.urlCopied': return 'URL copied to clipboard';
			case 'news.requestDetails.noRequest': return 'No request made yet';
			case 'news.requestDetails.showDetails': return 'Show Request Details';
			case 'news.requestDetails.hideDetails': return 'Hide Request Details';
			case 'news.results.title': return 'News Results';
			case 'news.results.found': return 'Found {count} news article(s)';
			case 'news.results.empty': return 'No news found for the selected criteria';
			case 'news.results.initial': return 'Configure parameters and click "Load News" to start';
			case 'news.results.searchParameters': return 'Search Parameters';
			case 'news.detail.title': return 'News Detail';
			case 'news.detail.metadata': return 'News Information';
			case 'news.detail.content': return 'Article Content';
			case 'news.education.title': return 'How this works';
			case 'news.education.description': return 'This demonstrates the news API workflow with separate pages for parameters, results, and detailed views.';
			case 'news.education.parameters': return 'Parameters';
			case 'news.education.parametersDescription': return 'Configure your search criteria here';
			case 'news.education.results': return 'Results';
			case 'news.education.resultsDescription': return 'View news articles matching your criteria';
			case 'news.education.detail': return 'Detail';
			case 'news.education.detailDescription': return 'See full content using the view API';
			case 'newsCategories.title': return 'News Categories';
			case 'newsCategories.fields.id': return 'ID';
			case 'newsCategories.fields.name': return 'Name';
			case 'newsCategories.parameters.title': return 'API Parameters';
			case 'newsCategories.parameters.domain': return 'Domain';
			case 'newsCategories.parameters.domainHint': return 'e.g., 7200 for national level';
			case 'newsCategories.parameters.domainDescription': return '4+ character domain code (required)';
			case 'newsCategories.parameters.language': return 'Language';
			case 'newsCategories.parameters.languageIndonesian': return 'Indonesian';
			case 'newsCategories.parameters.languageEnglish': return 'English';
			case 'newsCategories.parameters.languageDescription': return 'Content language for news categories';
			case 'newsCategories.parameters.searchNewsCategories': return 'Search News Categories';
			case 'newsCategories.requestDetails.title': return 'Request Details';
			case 'newsCategories.requestDetails.endpoint': return 'Endpoint';
			case 'newsCategories.requestDetails.method': return 'Method';
			case 'newsCategories.requestDetails.parameters': return 'Parameters';
			case 'newsCategories.requestDetails.curlExample': return 'cURL Example';
			case 'newsCategories.requestDetails.showDetails': return 'Show Request Details';
			case 'newsCategories.requestDetails.hideDetails': return 'Hide Request Details';
			case 'newsCategories.requestDetails.noRequestYet': return 'No request made yet';
			case 'newsCategories.results.title': return 'News Categories Results';
			case 'newsCategories.results.searchParameters': return 'Search Parameters';
			case 'newsCategories.results.categoriesFound': return 'categories found';
			case 'newsCategories.results.noDataFound': return 'No Categories Found';
			case 'newsCategories.results.noDataDescription': return 'Try adjusting your search parameters or check if the domain exists.';
			case 'newsCategories.categoryDetail.title': return 'Category Details';
			case 'newsCategories.categoryDetail.id': return 'Category ID';
			case 'newsCategories.categoryDetail.name': return 'Category Name';
			case 'newsCategories.education.title': return 'How this works';
			case 'newsCategories.education.description': return 'Browse news categories available for different domains and languages from BPS statistical data.';
			case 'newsCategories.education.parameters': return 'Parameters';
			case 'newsCategories.education.parametersDescription': return 'Configure domain and language settings';
			case 'newsCategories.education.results': return 'Results';
			case 'newsCategories.education.resultsDescription': return 'View news categories available for the domain';
			case 'newsCategories.education.categories': return 'Categories';
			case 'newsCategories.education.categoriesDescription': return 'Browse different news category classifications';
			case 'dynamicTables.title': return 'Dynamic Tables';
			case 'dynamicTables.parameters.title': return 'API Parameters';
			case 'dynamicTables.parameters.domain': return 'Domain';
			case 'dynamicTables.parameters.domainHint': return 'e.g., 7200 for national level';
			case 'dynamicTables.parameters.variable': return 'Variable';
			case 'dynamicTables.parameters.variableHint': return 'Select a statistical variable';
			case 'dynamicTables.parameters.selectYear': return 'Select Year';
			case 'dynamicTables.parameters.language': return 'Language';
			case 'dynamicTables.parameters.languageNote': return 'Applied to dynamic table content language';
			case 'dynamicTables.parameters.loadPeriods': return 'Load Available Periods';
			case 'dynamicTables.parameters.generateTable': return 'Generate Dynamic Table';
			case 'dynamicTables.parameters.loading': return 'Loading...';
			case 'dynamicTables.requestDetails.title': return 'Request Details';
			case 'dynamicTables.requestDetails.showDetails': return 'Show Request Details';
			case 'dynamicTables.requestDetails.hideDetails': return 'Hide Request Details';
			case 'dynamicTables.requestDetails.noRequest': return 'No request made yet';
			case 'dynamicTables.results.title': return 'Dynamic Table Results';
			case 'dynamicTables.results.periodsAvailable': return 'Available Periods';
			case 'dynamicTables.results.selectPeriod': return 'Select a period from above to generate table';
			case 'dynamicTables.results.tableGenerated': return 'Table generated successfully';
			case 'dynamicTables.results.empty': return 'No data available for selected criteria';
			case 'dynamicTables.results.initial': return 'Enter parameters above and click "Load Available Years" to get started';
			case 'dynamicTables.results.periodInitial': return 'Select a year from the dropdown above, then click "Load Dynamic Table" to view the data.';
			case 'dynamicTables.results.periodId': return 'Period ID';
			case 'dynamicTables.workflow.title': return 'Dynamic Table Workflow';
			case 'dynamicTables.workflow.description': return 'Follow these steps to generate a dynamic table from BPS data.';
			case 'dynamicTables.workflow.step1': return 'Step 1';
			case 'dynamicTables.workflow.step1Description': return 'Select domain and language, then choose a variable';
			case 'dynamicTables.workflow.step2': return 'Step 2';
			case 'dynamicTables.workflow.step2Description': return 'Load available periods for the selected variable';
			case 'dynamicTables.workflow.step3': return 'Step 3';
			case 'dynamicTables.workflow.step3Description': return 'Select a year/period and generate the table';
			case 'dynamicTables.states.initializing': return 'Initializing...';
			case 'dynamicTables.states.unknown': return 'Unknown state';
			case 'pressReleases.title': return 'Press Releases';
			case 'pressReleases.comingSoon': return 'Press Releases Page - Coming Soon';
			case 'pressReleases.detail.title': return 'Press Release Detail';
			case 'pressReleases.detail.forId': return 'Press Release Detail for ID: {id}';
			case 'staticTables.title': return 'Static Tables';
			case 'staticTables.comingSoon': return 'Static Tables Page - Coming Soon';
			case 'staticTables.detail.title': return 'Static Table Detail';
			case 'staticTables.detail.forId': return 'Static Table Detail for ID: {id}';
			case 'strategicIndicators.title': return 'Strategic Indicators';
			case 'strategicIndicators.comingSoon': return 'Strategic Indicators Page - Coming Soon';
			case 'subjects.title': return 'Subjects';
			case 'subjects.comingSoon': return 'Subjects Page - Coming Soon';
			case 'units.title': return 'Units';
			case 'units.comingSoon': return 'Units Page - Coming Soon';
			case 'variables.title': return 'Variables';
			case 'variables.comingSoon': return 'Variables Page - Coming Soon';
			case 'shared.pagination.previous': return 'Previous';
			case 'shared.pagination.next': return 'Next';
			case 'shared.pagination.loadMore': return 'Load More';
			case 'shared.pagination.page': return 'Page';
			case 'shared.pagination.previousPage': return 'Previous page';
			case 'shared.pagination.nextPage': return 'Next page';
			case 'shared.pagination.previousPageTooltip': return 'Previous page';
			case 'shared.pagination.nextPageTooltip': return 'Next page';
			case 'shared.codeSnippet.copyToClipboard': return 'Copy to clipboard';
			case 'shared.codeSnippet.codeCopied': return 'Code copied to clipboard';
			case 'shared.errorWidget.tryAgain': return 'Try Again';
			case 'shared.searchableDropdown.noItemsFound': return 'No items found';
			case 'shared.searchableDropdown.selectItem': return 'Select an item';
			case 'shared.requestDetails.title': return 'Request Details';
			case 'shared.requestDetails.method': return 'Method';
			case 'shared.requestDetails.url': return 'URL';
			case 'shared.requestDetails.parameters': return 'Parameters';
			case 'shared.requestDetails.urlCopied': return 'URL copied to clipboard';
			case 'shared.requestDetails.parametersCopied': return 'Parameters copied to clipboard';
			case 'validation.domainRequired': return 'Domain is required';
			case 'categories.imageNotAvailable': return 'Image not available';
			case 'categories.categoryId': return 'Category ID';
			case 'categories.releaseDate': return 'Release Date';
			case 'categories.imageUrl': return 'Image URL';
			case 'categories.tapToReadMore': return 'Tap to read more';
			case 'instructions.requestDetailsWillShow': return 'Request details will be shown in the results page';
			case 'instructions.onlyHandlesParameters': return 'This page only handles parameter configuration. Click "Search Domains" to see request details in the results page.';
			case 'instructions.languageLabels.indonesian': return 'Indonesian';
			case 'instructions.languageLabels.english': return 'English';
