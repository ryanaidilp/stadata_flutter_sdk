...
extension on Translations {
	...
	Map<String, dynamic> _initFlatMap() {
		...
		map['listApi.sections.statisticalClassifications.title'] = 'Statistical Classifications (KBLI)';
		map['listApi.sections.statisticalClassifications.description'] = 'Browse KBLI business activity classifications';
		...
		map['statisticalClassifications.title'] = 'Statistical Classifications (KBLI)';
