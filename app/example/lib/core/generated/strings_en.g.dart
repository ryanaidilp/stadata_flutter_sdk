...
extension on Translations {
	...
	Map<String, dynamic> _initFlatMap() {
		...
		map['listApi.sections.verticalVariables.description'] = 'Categorical dimensions and classification systems';
		map['listApi.sections.units.title'] = 'Units';
		map['listApi.sections.units.description'] = 'Units of measurement for statistical data';
		map['listApi.sections.periods.title'] = 'Periods';
		map['listApi.sections.periods.description'] = 'Time periods for statistical data';
		map['listApi.sections.derivedPeriods.title'] = 'Derived Periods';
		map['listApi.sections.derivedPeriods.description'] = 'Grouped and aggregated time periods';
		map['listApi.sections.derivedVariables.title'] = 'Derived Variables';
		map['listApi.sections.derivedVariables.description'] = 'Calculated and transformed statistical variables';
		...
		map['staticTables.description'] = 'Pre-defined statistical tables with data in HTML and Excel formats';
		map['staticTables.noDataFound'] = 'No static tables found';
		map['staticTables.found'] = ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(n,
				one: 'Found ${n} static table',
				other: 'Found ${n} static tables',
			);
		...
		map['units.found'] = ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(n,
				one: 'Found ${n} unit',
				other: 'Found ${n} units',
			);
		...
		map['verticalVariables.description'] = 'Categorical dimensions and classification systems';
		map['verticalVariables.noDataFound'] = 'No vertical variables found';
		map['verticalVariables.found'] = ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(n,
				one: 'Found ${n} vertical variable',
				other: 'Found ${n} vertical variables',
			);
		...
		map['verticalVariables.parameters.variableIDHint'] = 'e.g., 1234 (optional)';
