...
class VerticalVariableView extends GetView<VerticalVariableController> {
  const VerticalVariableView({super.key});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          LocaleKeys.page_vertical_variables.tr,
        ),
        centerTitle: true,
      ),
            ...
            Obx(
              () => NumberPaginator(
                ...
                onPageChange: (page) {
                  ...
                  controller.loadVerticalVariables();
                },
              ),
            ),
            16.verticalSpace,
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            LocaleKeys.properties_vertical_variable_item_id.tr,
                            style: context.textTheme.bodySmall?.copyWith(
                              color: Colors.blueGrey,
                            ),
                          ),
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            LocaleKeys.properties_vertical_variable_group_id.tr,
                            style: context.textTheme.bodySmall?.copyWith(
                              color: Colors.blueGrey,
                            ),
                          ),
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            LocaleKeys
                                .properties_vertical_variable_group_name.tr,
                            style: context.textTheme.bodySmall?.copyWith(
                              color: Colors.blueGrey,
                            ),
                          ),
